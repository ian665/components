      ...
      <div className="homepage-container">
        <header className="header">
          <div class="header-inner">
            <a class="header-logo" href='localhost:3000/home'>放假大學</a>
        ...
        <div className="module-container">
          ...
          <div className="module course-schedule">
            <h2>課表與已選課程</h2>
            <img className="table" src="/images/table.jpg" alt="time table"/>
            <ul className="selected-courses">
              <li>
                <button className="btn" onClick={() => alert("微積分 (星期一 09:00 - 10:30)")}>
                  ...
                  <span className="dot"></span>
                  <span className="dot"></span>
                  <span className="text">微積分 (星期一 09:00 - 10:30)  </span>
                </button>
              </li>
              <li>
                <button className="btn" onClick={() => alert("計算機科學基礎 (星期三 14:00 - 16:00)")}>
                  <span className="dot"></span>
                  <span className="dot"></span>
                  <span className="dot"></span>
                  <span className="dot"></span>
                  ...
                  <span className="dot"></span>
                  <span className="dot"></span>
                  <span className="text">計算機科學基礎 (星期三 14:00 - 16:00)  </span>
                </button>
              </li>
              <li>
                <button className="btn" onClick={() => alert("數據結構 (星期五 10:00 - 12:00)")}>
                  <span className="dot"></span>
                  <span className="dot"></span>
                  <span className="dot"></span>
                  <span className="dot"></span>
